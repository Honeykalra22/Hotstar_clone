...
function Tv() {
    ...
    return (
        <div className='h-auto'>
            ...
            {/* <h1 className=' capitalize text-2xl font-semibold mt-6 ml-2'>best channels</h1>
            <div
            ...
            >
                {All_videos.map((item, index) => {
                    if (item.type === 'channel') {
                        return (
                            <div key={index} className='min-w-[150px] cursor-pointer px-1 py-2 bg-gray-800 hover:scale-105 hover:duration-200 hover:ease-linear '>
            ...
            <h1 className='uppercase text-2xl mt-6 ml-2'>Popular channels</h1>
            ...
            <h1 className=' capitalize text-2xl font-semibold mt-6 ml-2'>Popular Movies </h1>
            <div
                className='flex space-x-4 py-4 px-2 scroll-smooth  overflow-x-auto no-scrollbar'
                ref={scrollContainer}
            >
                {All_videos.map((item, index) => {
                    if (item.type === 'popular') {
                        return (
                            <div key={index} className='min-w-[150px] cursor-pointer px-1 py-2 bg-gray-800 hover:scale-125 hover:duration-700 hover:ease-linear '>
                                <img src={item.image} alt={item.name} className='w-full h-auto rounded z-50' />
                                <h1 className='text-white capitalize mt-2'>{item.name}</h1>
                                <p className='text-gray-500 capitalize'>{item.lang}</p>
                            </div>
            ...
            <h1 className=' capitalize text-2xl font-semibold mt-6 ml-2'>best thriller movies</h1>
            <div
                className='flex space-x-4 py-4 px-2 scroll-smooth  overflow-x-auto no-scrollbar'
                ref={scrollContainer}
            >
